 ...
 */
 ...
 export class APIMaticWidget extends LitElement {
   ...
   @property({type: String}) apiKey = 'aNevcjuZmnpNoxByvnLpxOQfIyDDZQy0UswqjiWxeD3d6VdOelI6t7whM02BEZGG';
   @property({type: Boolean}) java = false;
   @property({type: Boolean}) dotNet = false;
   @property({type: Boolean}) php = false;
   @property({type: Boolean}) ts = false;
   @property({type: Boolean}) ruby = false;
   @property({type: Boolean}) python = false;
